...
def parse_args(args):
    ...
    parser.add_argument('--unmatched-threshold', type=float, default=0.4)
    ...
    parser.add_argument('--eval-score-threshold', type=float, default=0.5)
...
def everything(args):
    ...
    assigner = ArgmaxAssigner(iou_similarity, args.matched_threshold, args.unmatched_threshold, args.num_classes)
